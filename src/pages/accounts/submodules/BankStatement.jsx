...
export default function BankStatement() {
  ...
  return (
    <div className="hr-form">
      <div className="section-title">Bank Statement</div>
      ...
      {shown && (
        <div className="table-wrap">
          ...
          <table className="hr-table">
            <thead><tr><th>SNo.</th><th>Date</th><th>Description</th><th>Ref No</th><th>Debit (₹)</th><th>Credit (₹)</th><th>Balance (₹)</th></tr></thead>
