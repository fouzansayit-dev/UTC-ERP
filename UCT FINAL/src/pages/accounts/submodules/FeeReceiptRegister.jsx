...
export default function FeeReceiptRegister() {
  ...
  return (
    <div className="hr-form">
      <div className="section-title">Fee Receipt Register</div>
      ...
      {shown && (
        <div className="table-wrap">
          ...
          <table className="hr-table">
            <thead><tr><th>SNo.</th><th>Date</th><th>Student Name</th><th>Roll No</th><th>Fee Head</th><th>Amount</th><th>Receipt No</th><th>Pay Mode</th></tr></thead>
