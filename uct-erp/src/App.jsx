...
export default function App() {
  ...
  const [openMods, setOpenMods] = useState({
    ...
    student: false, abroad: false, visa: false, agent: false,
  ...
  // Build full searchable list: modules + all submodules
  const SEARCH_LIST = [
    ...
    ...MODULES.flatMap(m => m.subs.map(s => ({
        ...
        <div className="nav-right">
          ...
          <div className="user-wrap" ref={userRef}>
            ...
            <div className={'user-dd' + (userOpen ? ' open' : '')}>
              ...
              <div className="dd-item" onClick={() => { sessionStorage.removeItem('uct_user'); setIsLoggedIn(false); setUser(null); setUserOpen(false); }}>Sign Out</div>
            </div>
          </div>
        </div>
      </header>
